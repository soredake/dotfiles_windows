...
sudo { choco install -y --pin ds4windows syncthingtray tor-browser; choco install -y ytdownloader insomnia ppsspp steascree.install choco-cleaner nerdfont-hack tor --params "'/DesktopShortcut /No32bitIcon'"; choco install -y --pre pcsx2-dev rpcs3 --params "'/DesktopShortcut /NoAdmin'"; choco install -y choco-upgrade-all-at --params "'/WEEKLY:yes /DAY:SUN /TIME:19:00'" }
...
# Shortcuts
# https://github.com/ScoopInstaller/Scoop/issues/4212 https://github.com/microsoft/winget-cli/issues/3314 https://github.com/chtof/chocolatey-packages/pull/92
