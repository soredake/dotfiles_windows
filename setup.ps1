...
$packages='BlueStack.BlueStacks','9pmz94127m4g','microsoft.powershell','BiSS.WSLDiskShrinker','Microsoft.VisualStudioCode','TomWatson.BreakTimer','9nghp3dx8hdx','Python.Python.3','9n64sqztb3lm','rammichael.7+TaskbarTweaker.Beta','64Gram.64Gram','mcmilk.7zip-zstd','stromcon.emusak','AnthonyBeaumont.AchievementWatcher','oh-my-posh','SteamGridDB.RomManager'
...
# https://aka.ms/AAgnpjd https://aka.ms/AAh103i TODO: add to debloat list?
