...
scoop install cheat-engine yuzu-pineapple nodejs ryujinx winsetview czkawka-gui yt-dlp ffmpeg rclone bfg tor-browser psexec topgrade pipx plex-mpv-shim retroarch regscanner caffeine "https://raw.githubusercontent.com/aandrew-me/ytDownloader/main/ytdownloader.json" # proxychains
...
Install-Module -Name posh-git, Terminal-Icons, PSAdvancedShortcut, CompletionPredictor, PSCompletions
psc add npm winget
