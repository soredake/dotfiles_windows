...
sudo choco install -y --pin ds4windows syncthingtray tor-browser # syncthingtray is pinned until https://gitlab.com/yan12125/chocolatey-packages/-/issues/2 is fixed
