...
sudo choco install -y --pin ea-app jdownloader viber vigembus 64gram achievement-watcher ryujinx steam-rom-manager itch powertoys googledrive parsec goggalaxy hamachi protonvpn steam tor-browser hidhide
...
# TODO: will be nice if i can add multiple with one command
scoop bucket add extras
scoop bucket add games
scoop install cheat-engine
# scoop install yuzu-pineapple
