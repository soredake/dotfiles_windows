...
scoop install cheat-engine yuzu-pineapple proxychains nodejs ryujinx-ava winsetview czkawka-gui yt-dlp ffmpeg rclone adb bfg tor-browser psexec topgrade pipx plex-mpv-shim
