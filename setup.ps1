...
# winget autoupdate https://github.com/microsoft/winget-cli/issues/212, after winget gains auto-update support install pwsh from msstore https://github.com/PowerShell/PowerShell/issues/17232
