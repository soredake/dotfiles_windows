$machine = 'BlueStack.BlueStacks', 'lycheeverse.lychee', 'AppWork.JDownloader', 'Google.Drive', 'GOG.Galaxy', 'DupeGuru.DupeGuru', 'Syncplay.Syncplay', 'alexx2000.DoubleCommander', 'AntibodySoftware.WizTree', 'Rclone.Rclone', 'yt-dlp.yt-dlp', 'Gyan.FFmpeg', 'Parsec.Parsec', 'LogMeIn.Hamachi', 'ViGEm.ViGEmBus', 'Microsoft.PowerToys', 'GitHub.cli', 'mcmilk.7zip-zstd', 'Haali.WinUtils.lswitch', 'Libretro.RetroArch'
...
if (!$env:vm) {
  ...
  multipass launch --name primary -c 4 -m 4G --mount E:\:/mnt/e_host --mount C:\:/mnt/c_host
