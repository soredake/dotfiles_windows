...
sudo {
  ...
  # "OneDrive -Uninstall" "CopilotButton -Hide"
  ...
  winget install --no-upgrade -h --accept-package-agreements --accept-source-agreements EpicGames.EpicGamesLauncher WireGuard.WireGuard Microsoft.OfficeDeploymentTool Chocolatey.Chocolatey virtualbox Ryochan7.DS4Windows AppWork.JDownloader Google.GoogleDrive GOG.Galaxy dupeguru Syncplay.Syncplay doublecmd wiztree Parsec.Parsec hamachi 7zip-zstd handbrake eaapp KeePassXCTeam.KeePassXC protonvpn multipass msedgeredirect afterburner bcuninstaller voidtools.Everything strawberry-music AwthWathje.SteaScree PPSSPPTeam.PPSSPP sshfs-win Dropbox.Dash galaclient RamenSoftware.Windhawk qBittorrent.qBittorrentAdoptOpenJDK.OpenJDK.11 BiSS.WSLDiskShrinker HermannSchinagl.LinkShellExtension Plex.Plex Jellyfin.JellyfinMediaPlayer Jellyfin.Server XPFM11Z0W10R7G
  # lychee is installed in this scope until https://github.com/microsoft/winget-cli/issues/4044 is fixed
...
'games', 'extras', 'versions', 'sysinternals', 'java' | foreach { scoop bucket add $_ }
...
scoop install cheat-engine yuzu-pineapple proxychains nodejs ryujinx-ava winsetview czkawka-gui yt-dlp ffmpeg rclone adb bfg tor-browser psexec topgrade pipx plex-mpv-shim retroarch
