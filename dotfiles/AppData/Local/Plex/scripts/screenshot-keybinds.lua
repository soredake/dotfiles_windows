-- Taken from https://github.com/x1ao4/mpv-integration-for-plex/blob/main/en/screenshot-keybinds.lua
...
mp.add_key_binding("s", "screenshot", function()
    ...
    local path = "C:\\Users\\user\\Мой диск\\" -- Set the screenshot save path, for example, /Users/Username/Downloads/ or D:\\Users\\Username\\Downloads\\
