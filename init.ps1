...
sudo { winget install --no-upgrade -h --accept-source-agreements WingetPathUpdater Microsoft.PowerShell # https://github.com/microsoft/winget-cli/issues/3077 https://github.com/microsoft/winget-cli/issues/549#issuecomment-1675410316 https://github.com/microsoft/winget-cli/issues/222#issuecomment-1675434402
...
C:\Program` Files\PowerShell\7\pwsh.exe $env:r\setup.ps1
